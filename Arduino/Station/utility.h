...
#define ERROR2(x, y) if(DEBUG_LOG_LEVEL > 4) {Serial.print(x); Serial.println(y);}
#define WARN2(x, y) if(DEBUG_LOG_LEVEL > 5) {Serial.print(x); Serial.println(y);}
#define INFO2(x, y) if(DEBUG_LOG_LEVEL > 6) {Serial.print(x); Serial.println(y);}
#define DEBUG2(x, y) if(DEBUG_LOG_LEVEL > 7) {Serial.print(x); Serial.println(y);}
#else
#define ERROR(x, y)
#define WARN(x, y)
#define INFO(x, y)
